    ...
    public function run()
    {
        ...
        $categories = [
            ...
            $this->sss('Home & Furniture', 'Dom i Meble', 'სახლი და ავეჯი', 'weekend', [
                $this->sss('Furniture', 'Meble'),
                $this->sss('Kitchen & Dining', 'Kuchnia i jadalnia'),
                $this->sss('Bath & Bedding', 'Łóżko i Pościel'),
                $this->sss('Home Decor', 'Wystrój domu'),
                $this->sss('Garden & Outdoor', 'Ogród i odkryty'),
                $this->sss('Lightning', 'Błyskawica'),
                $this->sss('Pet Supplies', 'Artykuły dla zwierząt'),
                $this->sss('Home improvement', 'Majsterkowanie w domu'),
                $this->sss('Home electronics', 'Elektronika domowa'),
            ]),
            $this->sss('Sports & Outdoors', 'Sport i Outdoors', null, 'directions_bike', [
                $this->sss('Sports Clothing', 'Odzież sportowa'),
                $this->sss('Fitness & Bodybuilding', 'Fitness i kulturystyka'),
                $this->sss('Hunting & Fishing', 'Polowanie i wędkowanie'),
                $this->sss('Team Sports', 'Sporty drużynowe'),
                $this->sss('Fan Shop'),
