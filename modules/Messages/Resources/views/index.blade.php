				...
				<div class="_z013 _bgw _mb10">
					...
					<div class="_tbs _ov _fs16 _p10 _pl15">Messages</div>
						...
						<a class="_media _clear _p10 _hvrl" ng-repeat="thread in vm.threads" ng-href="@{{ thread.link }}" ng-class="{'_bg5':thread.unread}">
								...
								<div class="_clear _pr10">
									...
									<small class="_sub _cg _clear">
										<spaan ng-if="thread.last_replied" class="_c4">You:</spaan>
						...
						<div class="_posr _clear _mih250 _tac">
							<div class="_a0 _posa">
								<span class="_fs16 _c2">A list of dialogs is empty.</span><br>
								To contact someone go to profile of this person and click "Message"
							</div>
						</div>
						@endif
				</div>
