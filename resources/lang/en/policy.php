...
return [
	'text' => [
		...
		'General information' =>  'This policy sets out our privacy practices and explains how we handle the information we collect when you visit and use our sites, services, mobile applications, products, and content (“Services”).',
		'What we may collect' => "We collect information about what Nixler pages you access, information about your device (such as device or browser type), information you send us (such as an email address used to register or communicate with us), and referral information.",
		...
		'Email from Nixler' => 'Sometimes we’ll send administrative emails about account or service changes, or new policies. You can’t opt out of them. You can always opt out of non-administrative emails such as newsletter.',
		...
		'Disclosure of your information' => 'As a rule, we don’t share your personal information outside the company.',
		...
		'Cookies' => 'We use cookies and similar technologies such as pixels and local storage to recognize you when you return to our Services. We use them in various ways, for example to log you in, remember your preferences (such as default language), evaluate email effectiveness and personalize information.',
		...
		'Some third-party services that we use, such as <a href="https://www.cloudflare.com/security-policy/">Cloudflare</a> or <a href="http://www.google.com/policies/privacy/partners/">Google Analytics</a>, may place their own cookies in your browser. This Privacy Policy covers use of cookies by Nixler only and not the use of cookies by third parties.',
		'Data Storage' => 'Nixler uses third-party vendors and hosting partners, such as Digital Ocean, for hardware, software, networking, storage, and related technology we need to run Nixler. We maintain two types of logs: server logs and event logs.',
		...
		//'Modifying your personal information or deleting your account' => 'If you have a Nixler account, you can access and modify your personal information, or delete your account <a href="/">here</a>.',
		...
		'Data security' => 'We use encryption (HTTPS/TLS) to protect data transmitted to and from our site. However, no data transmission over the Internet is 100% secure, so we can’t guarantee security. You use the Service at your own risk, and you’re responsible for taking reasonable measures to secure your account (like using a strong password).',
		'Changes to this Policy' => 'Medium may periodically update this Policy. We’ll notify you about significant changes to it. The most current version of the policy will always be <a href="/policy">here</a>.',// and we will archive former versions of the policy here.'
		'Questions' => 'We welcome questions, concerns, and feedback about this policy at <a href="mailto:info@nixler.pl">info@nixler.pl</a>.'
	]
];