...
<div class="container" ng-controller="SellCtrl as vm">
				...
				<form class="_mb2 _fg @cannot('create', $product) _posr @endcannot" name="product" action="{{ $product->link() }}" method="POST">
					...
					<div class="_z013 _bgw _mb10 _brds2">
						...
						<div class="_p15 _bb1 _posr">
							...
							@else
							<span class="_a3 _mr15 _crp" id="import" ng-click="vm.openImport()">
								<i class="material-icons _fs18 _va4">link</i> @lang('Import')
							</span>
							@endif
						</div>
	...
	<div class="col-md-4 col-xs-12">
		<div class="_card _z013 _bgw _oh _p0"> 
			...
			<a class="_hvr1 _fs13 _clear _lim _hvrl" href="{{ url('/new-product') }}">
				<i class="material-icons _mr10 _va5 _fs18 _cbl">add</i> 
				@lang('Add Product')
			</a>

		</div>

		<div class="_card _z013 _bgw _oh _p0 _mt15 _mb15"> 
...
<script type="text/ng-template" id="/tmp/importer.html">
	<div class="_bb1 _p15 _fs18 _pb10 _cb">@lang('Import')</div>

	<form class="_clear _p15 _pt10" name="product" action="{{ $product->link('/import') }}" method="POST">
		{{ csrf_field() }}
		<small class="_clear _pb5">@lang('URL of product')</small>
		<input type="url" required name="url" minlength="2" class="_b1 _bcg _fe _brds3 _fes" placeholder="http://www.ebay.com/itm/Hanging-Chaise-Lounger-Chair-Arc-Stand-Air-Porch-Swing-Hammock-Chair-Canopy"> 
		<button class="_btn _bga _cb _hvra _mt15 _w100" type="submit"> 
			<i class="material-icons _mr5 _va5 _fs20">link</i> @lang('Import')
		</button>
	</form>
