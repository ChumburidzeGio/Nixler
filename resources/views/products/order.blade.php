                ...
                <div class="panel-body _pb15 _pl5 _pr5 _mb10">
                    <form role="form" method="POST" action="{{ route('order', ['id' => $product->id]) }}">
                        ...
                        <div class="col-xs-4 _mb15">
                            ...
                            <select selector model="vm.city" class="_b1 _bcg _brds3" options="vm.cities" placeholder="City" require>
                            </select>
                        ...
                        <div class="col-xs-5 _mb15">
                            ...
                            <input class="_b1 _bcg _fe _brds3 _fes" type="text" placeholder="Street address, block, flat" name="address" required>
                        ...
                        <div class="_clear _c3 _bg5 _p10 _brds3 ng-cloak" ng-if="vm.city && !vm.city.shipping">
                                Shipping is not available in this city. <a class="_c4" href="{{ route('find-thread', ['id' => $product->owner->id]) }}">Ask the seller</a> about delivery to your city or choose another one.
                        </div>

                            <p class="_clear _fs13 _c2 _mb0 _tac _mt5 ng-cloak" ng-if="vm.city.shipping_price">You will pay on delivery {{ $product->currency }} <span ng-bind="vm.price()"></span>.</p>
