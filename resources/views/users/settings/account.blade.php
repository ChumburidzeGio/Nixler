	...
	<div class="_bs012 _bgw _mb15 _db">
		...
		<div class="_p15 _bb1 _posr">
			<h2 class="_fs16 _cg _lh1 _db _telipsis _m0 _ml5">
				{{ trans('users.settings.account.title')}}
			</h2>
		</div>
		...
		<div class="_p15">
			<form class="form-horizontal" role="form" method="POST" action="{{ url('/settings/account') }}">
				...
				<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
					<label for="name" class="col-md-4 control-label">{{ trans('users.settings.account.name')}}</label>
				...
				<div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
					<label for="username" class="col-md-4 control-label">
						{{ trans('users.settings.account.username')}}
					</label>
				...
				<div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
					<label for="email" class="col-md-4 control-label">{{ trans('users.settings.account.email')}}</label>
				...
				<div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
					...
					<label for="phone" class="col-md-4 control-label">{{ trans('users.settings.account.phone')}}</label>
					...
					<div class="col-md-6">
						   ...
						   <div class="_b1 _bgwt4 _c3 _bcg _clear _p15 _mb10 _brds2">
							<p class="_clear">
								A 5-digit activation code will be texted to your phone within a few minutes.</p>

								<small class="_clear _pb5">Confirmation code</small>
								<div class="row">
								<div class="col-xs-7">
								...
								<div class="col-xs-3">
									<button class="_btn _bgi _cw">
										{{ trans('users.settings.emails.verify')}}
									</button>
								</div>
								</div>
							</div>
					...
					<div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
						...
						<div class="col-md-6">
							<select selector model="vm.city_id" value-attr="id" label-attr="name" class="_b1 _bcg _brds3" options="vm.cities" placeholder="{{ trans('users.settings.addresses.city_placeholder') }}" ng-init="vm.city_id={{ old('city_id', $user->city_id)}}" require="1" id="city">
							</select>
					...
					<div class="form-group{{ $errors->has('website') ? ' has-error' : '' }}">
						<label for="website" class="col-md-4 control-label">
							{{ trans('users.settings.social.website')}}
						</label>

						<div class="col-md-6">
							<input id="website" type="text" class="_b1 _bcg _brds3 _fe _fes" name="website" value="{{ $user->getMeta('website') }}" placeholder="{{ trans('users.settings.social.website_plac')}}">
					...
					<div class="form-group{{ $errors->has('headline') ? ' has-error' : '' }}">
						<label for="headline" class="col-md-4 control-label">
							{{ trans('users.settings.account.headline')}}
						</label>

						<div class="col-md-6">
							<input id="headline" type="text" class="_b1 _bcg _brds3 _fe _fes" name="headline" value="{{ $user->getMeta('headline') }}" placeholder="{{ trans('users.settings.account.headline_helper')}}">
					...
					<div class="form-group">
						<div class="col-md-6 col-md-offset-4">
							<button type="submit" class="_btn _bgi _cw">
								{{ trans('users.settings.account.save')}}
							</button>
						</div>
					</div>
				</form>
		...
		<div class="_bs012 _bgw _mb15 _clear">
			...
			<div class="_p15 _bb1 _posr">
				<h2 class="_fs16 _cg _lh1 _db _telipsis _m0 _ml5">
					{{ trans('users.settings.password.title')}}
				</h2>
			</div>
				...
				<form class="form-horizontal" role="form" method="POST" action="{{ url('/settings/password') }}">
					...
					<div class="form-group{{ $errors->has('current_password') ? ' has-error' : '' }}">
						<label for="current_password" class="col-md-4 control-label">
							{{ trans('users.settings.password.current')}}
						</label>
					...
					<div class="form-group{{ $errors->has('new_password') ? ' has-error' : '' }}">
						<label for="new_password" class="col-md-4 control-label">
							{{ trans('users.settings.password.new')}}
						</label>
					...
					<div class="form-group{{ $errors->has('new_password_confirmation') ? ' has-error' : '' }}">
						<label for="new_password_confirmation" class="col-md-4 control-label">
							{{ trans('users.settings.password.verify')}}
						</label>
					...
					<div class="form-group">
						<div class="col-md-6 col-md-offset-4">
							<button type="submit" class="_btn _bgi _cw">
								{{ trans('users.settings.password.save')}}
							</button>
						</div>
					</div>
				</form>
